	...
	app.post('/api/search', (req, res) => {
	    var claimNumber = req.body.claimNumber;
	    var searchAction = req.body.action;
	    searchAction = searchAction.toString().toUpperCase();
	    symbolicNames = process.env[`${searchAction}_SYMBOLIC_NAME`].toString().split(',');
	    columnHeaders = process.env[`${searchAction}_HEADERS`].toString().split(',');
	    request.get({
